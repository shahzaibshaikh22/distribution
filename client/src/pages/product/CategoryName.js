...
import { useAddCategoryMutation } from "../../redux/features/apiSlices/product/categorySlice";
    ...
    return (
        <div className="w-full flex  text-white px-4">
            ...
            <div className="w-full ">
                <TopBar />
                <SectionBar sectionHeading="Category Name" />
                {/* form section */}
                <div className={`w-full md:px-10 mainContainerForm relative rounded-xl ${modes === "dark" ? 'bg-darksecondary text-white' : 'bg-white text-gray-800'} h-[4rem]`}>
                    <div className='md:px-0 px-10'>
                        <h1 className='text-center md:text-md text-sm pt-6 font-semibold mb-5'>Category</h1>
